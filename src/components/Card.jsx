export default function Card() {
  return (
    <>
      <div
        id="card"
        className="md:w-32 w-full h-32 rounded-lg overflow-hidden bg-cover text-center"
      ...
      >
        <button id="content" className="bg-black w-full h-full bg-opacity-50 p-3 active:bg-red-300 relative">
          ...
          <div
            className="absolute bottom-1 right-2 bg-white p-1 px-3 rounded-full text-sm bg-opacity-80 bg-zinc-900"
          >32</div>
        </button>
      </div>
    </>
